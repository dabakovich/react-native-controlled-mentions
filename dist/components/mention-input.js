...
const MentionInput = (_a) => {
    var { value, onChange, partTypes = [], inputRef: propInputRef, containerStyle, onSelectionChange, onChangePartsData } = _a, textInputProps = __rest(_a, ["value", "onChange", "partTypes", "inputRef", "containerStyle", "onSelectionChange", "onChangePartsData"]);
    const textInput = react_1.useRef(null);
    const [selection, setSelection] = react_1.useState({ start: 0, end: 0 });
    const [partsData, setPartsData] = react_1.useState([]);
